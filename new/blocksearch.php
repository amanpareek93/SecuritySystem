...
$sql="SELECT DISTINCT backupt.name,backupt.reg,backupt.from,backupt.to,backupt.hours,backupt.place,backupt.purpose,backupt.date,backupt.out,backupt.in FROM backupt join userdetails where userdetails.block LIKE '%$q%' order by date desc" ;
